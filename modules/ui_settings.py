...
class UiSettings:
        ...
        with gr.Blocks(analytics_enabled=False) as settings_interface:
            ...
            with gr.Tabs(elem_id="settings"):
                ...
                with gr.TabItem(
                    ...
                    gr.HTML(
                        '<a href="./internal/sysinfo-download" class="sysinfo_big_link" download>Download system info</a><br /><a href="./internal/sysinfo">(or open as text in a new page)</a>',
            ...
            unload_sd_model.click(
                fn=sd_models.unload_model_weights, inputs=[], outputs=[]
            )

            reload_sd_model.click(
                fn=sd_models.reload_model_weights, inputs=[], outputs=[]
            )
    ...
    def add_functionality(self, demo):
        ...
        for _i, k, _item in self.quicksettings_list:
            ...
            change_handler = (
                component.release if hasattr(component, "release") else component.change
            )
            change_handler(
